...
cr_e1m1Props = [
  ...
  1, 19, 0.7, 13.5, 1,     // Lamp
  1, 20, 0.7, 6, 1,        // Lamp
  2, 15.5, 0, 14.5, 1,     // Floor Lamp
  2, 26.5, 0, 11.5, 1,     // Floor Lamp
  2, 21, 0, 0.5, 1,        // Floor Lamp
  3, 16.5, 0, 4.5, 1,      // Trash can
  4, 19, 0, 14.5, 1,       // Radio
  5, 16.5, 0, 17, 1,       // Coathanger
  6, 11.5, 0.8, 4.5, 0,    // Fruit Bowl
  7, 10.3, 0.8, 4.8, 0,    // Pan
  8, 11, 0.8, 7.5, 1,      // Plates
  9, 16.5, 0, 8.5, 1,      // Plants
  9, 22, 0, 13, 1,         // Plants
  12, 26.5, 0, 7.5, 1,     // Cat post
  13, 23.5, 0.4, 10, 0,      // Bottle
  14, 10.5, 0.7, 14.5, 0,  // Telephone
  15, 9.5, 0.7, 11, 0,     // Box
  // 2nd Floor
  0, 10.5, 2, 13.5, 1,      // Toilet
  1, 16, 2.7, 5.5, 1,       // Lamp
  2, 18, 2, 10.5, 1,        // Floor Lamp
  2, 25.5, 2, 10.5, 1,      // Floor Lamp
  9, 19, 2, 10.5, 1,        // Plants
  10, 23.2, 2.7, 10.5, 0,   // Mug
  11, 12, 2.7, 5.5, 0,      // Alarm clock
];
cr_smallUvs = [
  [0,0,1/8,1],
  [1/8,0,2/8,1],
...
cr_img = [
  ...
  // Props 28
  [128, 32, "                                   qqqqqqqqqqq                                         qqq                                                                          qu2u2u2uq                                       qq q5q qq                                                                        qu2u2uq                                        q5qq5qq7q                                                                         qqqqq                                          q5q5qq7q                                                                          qeq            qqqq                            qq5qq7q                                       qqqqqqq          qqqqq             qeq           q7887q                            q5qq7q                                       qlllllq          qu2uq             qeq          q78qq87q           q   q           q5qq7q                                      qqqkkklq         qu222uq            qeq          q788t87q           q   q           q5q qq                                       qkkkklq         qu222uq            qdq          qqqqqqqq            q q            q5q           qq     q                      qqqqqqqqq       qu22u22uq           qdq          q788887q            q q            q5q          q78q qqqbq                     qkqqqqqlq       qqqqqqqqq           qdq          q788t87q        qqqqqqqqq          q5q          q77qqabaq                      qlkkkkklq         q77qq             qdq          q788t87q        q5555qq5q          q5q          qqqqqqqqq        qqqqqq         qkkkklq         q778q8q            qeq          q788t87q        q666qmlqq          q5q          q4444444q        qmmmmqqqqq      qlklq          q788q8q            qeq          q788t87q        q555qlmqq          q5q          q4545454q        qnmmnqqqqq     qlqqqlq          q777q            qqqqq         q788887q        q6666qq6q        qqqqqqq         qq555qq         qnnnnq         qlllllq           qqq            qnmmmnq        qqqqqqqq        qqqqqqqqq       q5555555q          qqq           qqqqqq                                                                                                                                                        q  q q  q                                                                                                                      qdqqdqdqqdq                                                                                                                     qdeqeqeqdeq                                                                                                                      qdqeqqdqqdq                                                                                                                    qeqdqdeqedq                                                                                                                      qeqdqdeqq                                                                                                                       qqqqqqqqq                                          qqqq                                                                           qmmmq                                            q34q                                                                          qmllmmq                            qq             q43q             qq           qqqqqqqqq      qqqqqqqqqq                       qmlmmmq                           qmkq            q34q             qq          q322222223q     q55654545q       qqqqqqq        qmllmmmmq                         qmokmq           q43q            qkkq        q32222222223q    q44545643q       q32223q        qmllmmmmq          qqqq           qkkomq           q34q            q7kq        q33qqqqqqq33q    qqqqqqqqqq        qqqqq         qmmmmmmmq          qllqqq          qmmq            q43q            q77q       q qq3q3q3q3qq     q65343456q       q33333q         qmmmmmq           qllqqq          qqqq         qqqqqqqqqq         q77q       qq q3333333q      q54545644q        qqqqq           qqqqq            qqqq           qmmmmq        q55555555q         qqqq        qqq3q3q3q3q      qqqqqqqqqq   "],
  // Bedroom walls 29
...
cr_img_clamp_to_edges = [3, 28, 32, 33, 34, 35],
cr_newImage = (cr_src) => {
  const img = new Image();
  img.src = cr_src;
  return img;
...
function cr_doesCollidesWithProps(P, cr_2d = 0) {
  for (let I=0;I<cr_props.length;I++) {
    ...
    if (cr_distance <= 0.5) return cr_prop;
  }
  return 0;
}
